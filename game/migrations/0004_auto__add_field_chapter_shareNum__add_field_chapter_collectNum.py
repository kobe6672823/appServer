...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Chapter.shareNum'
        db.add_column(u'game_chapter', 'shareNum',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Chapter.collectNum'
        db.add_column(u'game_chapter', 'collectNum',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Chapter.shareNum'
        db.delete_column(u'game_chapter', 'shareNum')

        # Deleting field 'Chapter.collectNum'
        db.delete_column(u'game_chapter', 'collectNum')
    ...
    models = {
        u'game.chapter': {
            ...
            'createTime': ('django.db.models.fields.BigIntegerField', [], {'default': '1385016963'}),
        ...
        u'game.story': {
            ...
            'support': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'timeStamp': ('django.db.models.fields.BigIntegerField', [], {'default': '1385016963'}),
