...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'IOSDeviceToken'
        db.create_table(u'game_iosdevicetoken', (
            ('token', self.gf('django.db.models.fields.CharField')(max_length=32, primary_key=True)),
        ))
        db.send_create_signal(u'game', ['IOSDeviceToken'])


    def backwards(self, orm):
        # Deleting model 'IOSDeviceToken'
        db.delete_table(u'game_iosdevicetoken')
    ...
    models = {
        u'game.chapter': {
            ...
            'createTime': ('django.db.models.fields.BigIntegerField', [], {'default': '1388046605'}),
        ...
        u'game.iosdevicetoken': {
            'Meta': {'object_name': 'IOSDeviceToken'},
        ...
        u'game.story': {
            ...
            'support': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'timeStamp': ('django.db.models.fields.BigIntegerField', [], {'default': '1388046605'}),
