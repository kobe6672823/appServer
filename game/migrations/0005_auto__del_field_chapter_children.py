...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Chapter.children'
        db.delete_column(u'game_chapter', 'children')


    def backwards(self, orm):
        # Adding field 'Chapter.children'
        db.add_column(u'game_chapter', 'children',
    ...
    models = {
        u'game.chapter': {
            ...
            'createTime': ('django.db.models.fields.BigIntegerField', [], {'default': '1387468023'}),
        ...
        u'game.story': {
            ...
            'support': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'timeStamp': ('django.db.models.fields.BigIntegerField', [], {'default': '1387468023'}),
