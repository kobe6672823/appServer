...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Chapter.storyid'
        db.alter_column(u'game_chapter', 'storyid', self.gf('django.db.models.fields.BigIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Chapter.storyid'
        db.alter_column(u'game_chapter', 'storyid', self.gf('django.db.models.fields.BigIntegerField')(default=0))
    ...
    models = {
        u'game.chapter': {
            ...
            'createTime': ('django.db.models.fields.BigIntegerField', [], {'default': '1382061382'}),
        ...
        u'game.story': {
            ...
            'support': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'timeStamp': ('django.db.models.fields.BigIntegerField', [], {'default': '1382061382'}),
